    ...
    public static class Globals
    {
        ...
        public static void sendEmail()
        {
            try
            {
                ...
                mail.From = new MailAddress("phamvantu.cs@gmail.com");

                mail.To.Add("pvtu@cmc.com.vn");
                ...
                SmtpServer.Credentials = new System.Net.NetworkCredential("phamvantu.cs@gmail.com", "May1992@@");
        ...
        public static DataTable GetSapDataTableSQL(string sql)
        {
            try
            {
                //// cách 1 mã hóa chuỗi kết nối
                ...
                //string connection = $"Data Source={server};Initial Catalog={dbName};Persist Security Info=True;User ID={user};Password={password}";
                ...
                using (SqlConnection yourConnection = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(sql, yourConnection))
                    {
        ...
        public static SAPbouiCOM.Conditions GetMultiCondition(ref SAPbouiCOM.Conditions Conditions, string[] Alias, string[] Value, SAPbouiCOM.BoConditionOperation[] Operation, SAPbouiCOM.BoConditionRelationship[] Relationship, string[] ConEndVal)
        {
            ...
            Conditions = (SAPbouiCOM.Conditions)SBO_Application.CreateObject(SAPbouiCOM.BoCreatableObjectType.cot_Conditions);
        ...
        public static void CreateField(string name, string description, SAPbobsCOM.BoFieldTypes fieldDataType, SAPbobsCOM.BoFldSubTypes fieldSubType, int size, string tableName, SAPbobsCOM.Company oCompany, SAPbouiCOM.Application SBO_Application)
        {
            try
            {
                GC.Collect();
        ...
        public static void CreateField(string name, string description, SAPbobsCOM.BoFieldTypes fieldDataType, SAPbobsCOM.BoFldSubTypes fieldSubType, int size, string tableName, string defaultValue, List<string[]> validValues, SAPbobsCOM.Company oCompany, SAPbouiCOM.Application SBO_Application)
        {
            try
            {
                GC.Collect();
        ...
        public static long DisplayDate(SAPbouiCOM.ItemEvent pVal, ref string sErrDesc)
        {
            ...
            try
            {
                ...
                oItem.Left = 9;
                oItem.Width = 65;
                oTxt = (SAPbouiCOM.StaticText)oItem.Specific;
                ...
                oEdit = (SAPbouiCOM.EditText)oForm.Items.Item("FromDate").Specific;
